...
(function(global, factory) {
	...
	Panzoom.defaults = {
		...
		//increment: 0.3, // saurabh
		increment: 0.5, // saurabh
	...
	Panzoom.prototype = {
		...
		zoom: function(scale, opts) {
			...
			if(Math.ceil(matrix[0])==1){
				this.$set.addClass('zoom-out').removeClass('zoom-in');
			}else if(Math.ceil(matrix[0])>1){
				this.$set.addClass('zoom-in').removeClass('zoom-out');
			}
		...
		_initStyle: function() {
			...
			if ($parent.length && !$.nodeName(this.parent, 'body')) {
				styles = {
					//overflow: 'hidden' //saurabh :comentted to get scroll
					overflow: 'scroll'
				};
